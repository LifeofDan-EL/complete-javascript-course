...
const calcAverageHumanAge = function (ages) {
  // const dogHumanAge = [];
  // for (const dogAges of ages) {
  //   if (dogAges <= 2) dogHumanAge.push(2 * dogAges);
  //   else if (dogAges > 2) dogHumanAge.push(16 + dogAges * 4);
  // }
  ...
  const adultDogs = dogHumanAge.filter(dogAges => dogAges >= 18);
